...
def validate_input(string:str) -> Tuple[bool,Tuple[int,int]]:
    ...
    if len(split_string) < 2:
      print("Fel input")
      return(False,None)
    if str.isdigit(split_string[0]) and str.isdigit(split_string[1]):
      print("Fel input")
      return(False,None)
...
def check_winner():
    ...
    if len(across_set1) == 1 and row_set.pop() != "#":
        return True
    if len(across_set2) == 1 and row_set.pop() != "#":
        return True
